...
public class AccountsController {
    ...
    public ResponseEntity<String> getBuildInfo() {
        logger.debug("Get build info method called");
//        throw new TimeoutException("Build info is not available");
        return ResponseEntity.status(HttpStatus.OK).body(buildVersion);
    }

    public ResponseEntity<String> getBuildInfoFallback(Throwable throwable){
        logger.debug("Get build info fallback method called");
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Build info is not available");
    }
